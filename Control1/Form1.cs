...
namespace Control1
{
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                btnRed.BackColor = Color.Yellow; //버튼의 배경색을 노란색으로 바꾼다.
                btnRed.Text = "노란색"; //버튼의 글자를 노란색으로 바꾼다.
            }
            else if (btnRed.Text == "노란색") //if 이외 조건 추가
            {
                btnRed.BackColor = Color.Green; //버튼의 배경색을 초록색으로 바꾼다.
                btnRed.Text = "초록색"; //버튼의 글자를 초록색으로 바꾼다.
            }
            else if (btnRed.Text == "초록색") //if 이외 조건 추가
            {
                btnRed.BackColor = Color.Blue; //버튼의 배경색을 파란색으로 바꾼다.
                btnRed.Text = "파란색"; //버튼의 글자를 파란색으로 바꾼다.
            }
            else if (btnRed.Text == "파란색") //if 이외 조건 추가
            {
                btnRed.BackColor = Color.Purple; //버튼의 배경색을 보라색으로 바꾼다.
                btnRed.Text = "보라색"; //버튼의 글자를 보라색으로 바꾼다.
            }
            else //if의 조건 이외 모든것
            {
                btnRed.BackColor = Color.White; //버튼의 배경색을 하얀색으로 바꾼다.
        ...
        {
            //변수 하나에 대해 여러 조건을 만들 때 사용
            //break 빼고 case 사용하는 방법
            //case만 남겨두고 명령문과 break를 제외
            //goto case를 사용
